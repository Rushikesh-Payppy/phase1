                    ...
                    <div className="flex flex-col gap-10 ">
                        <div className="flex flex-col gap-8">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <button className={`py-4 px-7 w-full  background-custom-grey900 shadow-sm custom-text-white all-caps-12-bold `} onClick={handleCorrectButton}>{loadingAnimation?<LoadingAnimation borderColor='border-white' />:'Confirm'}</button>
                            </div>
