  ...
  return (
    <article className={ "max-w-[52.7vh] h-screen min-w-[200px] min-h-[200px] mx-auto border-r-[0.5px] border-l-[0.5px] custom-border-grey950 overflow-x-hidden overflow-y-visible scroll-smooth "+plus_jakarta_sans.className} >
      ...
      <header className="border-b-[0.5px] custom-border-grey800 ">
        ...
        {/* login/Signup button */}
          <div className=" mt-3 mb-16">
            <Link href="#" className=" uppercase background-custom-green py-4 px-7 all-caps-12-bold custom-text-grey950  member-button-gradient border-[0.5px] custom-border-grey800 ">
            login/Signup
            </Link>
          </div>
        </div>
      ...
      <main className=" flex flex-col">
        {/* help & support button */}
        <AccountButton href="/my-account/help-and-faq"  buttonName="Help & Support" buttonIcon={helpIcon}/>
     ...
     {/* copyright section */}
      ...
      <footer className=" mx-[72px] mt-2 mb-10 new-user-page-footer-gradient">
        {/* <AccountFooter /> */}
        <StoreFooter/>
      </footer>
