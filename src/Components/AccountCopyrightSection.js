...
//logos
import instagram from "@/Images/account/Insta-icon.svg";
import youtube from '@/Images/account/youtube-icon.svg';
    ...
    <>
      <section className={"gap-4 px-6 flex flex-col items-center " + plus_jakarta_sans.className}>
        <div className="gap-5 flex flex-row justify-center ">
          <Link href="https://www.youtube.com/@payppy">
            <Image src={youtube} width={18} height={18} alt="" quality={100} />
          </Link>

          <Link href="https://www.instagram.com/payppy.app/">
